...
ATiagoOld::ATiagoOld(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void ATiagoOld::SetupWheelDrives()
{
...
bool ATiagoOld::SetupConstraintsAndPhysics()
{
    if (bBodyComponentsCreated)
    {
