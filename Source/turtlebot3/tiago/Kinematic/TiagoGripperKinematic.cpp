...
bool ATiagoGripperKinematic::SetupConstraintsAndPhysics()
{
    if (bBodyComponentsCreated)
    {
        ...
        AddMimicJointToJoint(TEXT("gripper_finger_joint"), TEXT("gripper_right_finger_joint"));
        ...
        GripperLink_GripperRightFingerLink->SetRelativeRotation(FRotator(0,180,0));
        ...
        GripperLeftFingerLink_GripperFingerMountL->SetRelativeRotation(FRotator(0,90,0));
        ...
        GripperFingerMountL->SetRelativeRotation(FRotator(0,-180,0));
        ...
        GripperFingerMountR->SetRelativeRotation(FRotator(0,-180,0));
